...
int sendFd(int pipe_fd, int newFd, int exitFlag);//send the newFd to connect with client,
//from parent to child

int recvFd(int pipe_fd, int *pNewFd, int *pExitFlag);//receve the newFd from 
//parent to child
